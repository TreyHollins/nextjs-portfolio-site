...
export default function LatestCode() {
    ...
    useEffect(() => {
        const asyncEffect = async () => {
            let latestRepos = await getLatestRepos();
            setRepos(latestRepos);
        };
        asyncEffect();
    }, []);
    return (
        <section className="bg-[#202931] pb-40">
            <div className="max-w-6xl mx-auto">
                <div className="flex flex-col md:flex-row justify-between items-center md:pt-40 mx-10">
                    <h1 className="text-6xl lg:text-9xl max-w-lg font-bold text-gray-600 my-20 md:my-0 text-center lg:text-left">Latest Code</h1>

                    <a
                        href={'https://github.com/TreyHollins'}
    ...
    return (
        <div className="github-repo">
            ...
            <a href={latestRepo.clone_url} className="font-semibold group flex flex-row space-x-2 w-full items-center">
                <p className="text-gray-300">View Repository </p>
