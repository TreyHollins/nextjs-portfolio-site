...
function Hero(): JSX.Element {
    return (
        <div className="flex w-full h-screen justify-center bg-[url('../images/hero4.avif')] bg-no-repeat bg-cover bg-fixed bg-center z-0 ">
            <div className="justify-around content-around w-full pt-24">
                ...
                <p className="font-medium text-lg sm:text-xl text-[#070723] text-center">
                    I&apos;m a graduate of the University of Cincinnati looking for a Software Developer position
                </p>
            </div>
        </div>
    );
